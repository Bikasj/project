                  ...
                  <div class="">
                    <ul class="list-inline justify-content-center">
                      <li class="list-inline-item">
                       <a data-toggle="tooltip" data-placement="top" title="view" class="view" href="/rooms/viewbookingrequest/<?php echo $rooms->room_id?>">
                          <i class="fa fa-eye"></i>
                        </a>
                      </li>
                      <li class="list-inline-item">
                        <a class="edit" data-toggle="tooltip" data-placement="top" title="Approve" href="/rooms/approve/<?php echo $rooms->room_id?>">
                          <i class="fa fa-check"></i>
                        </a>
                      </li>
                      <li class="list-inline-item">
                        <a class="delete" data-toggle="tooltip" data-placement="top" title="Decline" href="/rooms/decline/<?php echo $rooms->room_id?>">
