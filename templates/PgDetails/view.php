  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
        <!-- Recently Favorited -->
        <div class="widget dashboard-container my-adslist"><h3 style="text-shadow: 2px 2px 5px grey;"><i class="fa fa-home" ></i> My PGs</h3>

<?php 
        // echo  $this->Html->link('Edit', ['id'=>$user->user_id,'class' => 'edit nav-link text-white btn btn-sm btn-success  float-right'])."  ";  
        //     if($user->status==1)
               echo '<a data-toggle="tooltip" data-placement="top" class="nav-link text-white btn btn-sm btn-success  float-right" title="Edit" href="/PgDetails/edit/'.$pg_details->pg_id.'">
                          <i class="fa fa-pencil"></i>
                        </a>';
                            if($pg_details->status==1)
                              
                        echo '<a data-toggle="tooltip" data-placement="top" class="nav-link text-white btn btn-sm btn-danger  float-right" title="Block" href="/PgDetails/block/'.$pg_details->pg_id.'">
                          <i class="fa fa-ban"></i>
                        </a></li>'; 
                            else
                    
                        echo '<a data-toggle="tooltip" data-placement="top" class="nav-link text-white btn btn-sm btn-primary  float-right" title="Unlock" href="/PgDetails/block/'.$pg_details->pg_id.'">
                          <i class="fa fa-ban"></i>
                        </a></li>';
    ?>
                  ...
                  <div class="">
                    <ul class="list-inline justify-content-center">
                      <li class="list-inline-item">
                        <a  id="<?=$rooms->room_id?>" data-toggle="" data-placement="top" title="view" class="view" href="/rooms/view/<?php echo $rooms->room_id?>">
                          <i class="fa fa-eye"></i>
                        </a>
                      </li>
                      <li class="list-inline-item">
                        <a class="edit" id="<?=$rooms->room_id?>" data-toggle="" data-placement="top" title="Edit" href="/rooms/edit/<?php echo $rooms->room_id?>">
                          <i class="fa fa-pencil"></i>
                        </a>
                      </li>
                        <?php 
                        ...
                        <a class="delete" data-toggle="" data-placement="top" title="Block" href="/rooms/block/'.$rooms->room_id.'">
                          <i class="fa fa-ban"></i>
                        </a></li>'; 
                            else
                                echo '<li class="list-inline-item">
                        <a class="delete" data-toggle="" data-placement="top" title="Unblock" href="/rooms/block/'.$rooms->room_id.'">
                          <i class="fa fa-ban"></i>
                        </a></li>';  ?>
