...
<footer class="footer section section-sm">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-2 offset-lg-1 col-md-3">
        <div class="block">
          <h4>Dashboard-Listing</h4>
          <ul>
            <li><a href="/admin/users/pgowners">PG Owners</a></li>
            <li><a href="/admin/rooms/roomstatus">Rooms Available/Booked</a></li>
 ...
 <div class="container">
    <div class="row">
      <div class="col-lg-2 offset-lg-1 col-md-3">
        <div class="block">
          <h4>My Dashboard Lists</h4>
          <ul>
            <li><a href="/pg-details/pg">My Pgs</a></li>
            <li><a href="/users/transients">All Transient Guests</a></li>
