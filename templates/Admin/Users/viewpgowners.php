  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
        <!-- Recently Favorited -->
        <div class="widget dashboard-container my-adslist"><h3 style="text-shadow: 2px 2px 5px grey;"><i class="fa fa-user" ></i> PG Owners</h3>

<?php 
        
                       echo '<a data-toggle="tooltip" data-placement="top" class="nav-link text-white btn btn-sm btn-success  float-right" title="Edit" href="/admin/users/editpgowners/'.$user->user_id.'">
