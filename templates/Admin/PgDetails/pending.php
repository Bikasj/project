    ...
    <div class="row">
        ...
        <div class="sidebar">
          ...
          <div class="widget user-dashboard-menu">
            <ul>
              ...
              <li class="active"><a href="/admin/PgDetails/pending"><i class="fa fa-bolt"></i> Pending Approval<span><?=$pending?></span></a></li>
      ...
      <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
        ...
        <div class="widget dashboard-container my-adslist">
          <h3 style="text-shadow: 2px 2px 5px grey;"><i class="fa fa-bolt" ></i> Pending Approval</h3>
          <table class="table table-responsive product-dashboard-table">
            ...
            <tbody>
                ...
                <td class="product-category"><span class="status active"><?php if($pg->status==0 || 2)
                    ...
                    <ul class="list-inline justify-content-center">
                      <li class="list-inline-item">
                        <a  id="<?=$pg->pg_id?>" data-toggle="tooltip" data-placement="top" title="view" class="view" href="/admin/PgDetails/viewpg/<?php echo $pg->pg_id?>">
                          <i class="fa fa-eye"></i>
                        </a>
                      </li>
                      <li class="list-inline-item">
                        <a class="edit" data-toggle="tooltip" data-placement="top" title="Approve" href="/admin/PgDetails/approve/<?php echo $pg->pg_id?>">
